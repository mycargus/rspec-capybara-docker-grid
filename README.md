[![CI](https://github.com/mycargus/rspec-capybara-docker-grid/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/mycargus/rspec-capybara-docker-grid/actions/workflows/ci.yml)
